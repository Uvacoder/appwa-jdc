    ...
    >
      ...
      {isEmpty ? (
        <div className="flex-1 px-4 flex flex-col justify-center items-center">
          <span className="border border-dashed border-theme-primary rounded-full flex items-center justify-center w-16 h-16 p-12 bg-theme-secondary text-secondary">
